...
var Aufgabe_3;
(function (Aufgabe_3) {
    let _serverUrl = "http://127.0.0.1:8100";
    function main() {
        /*
        ...
        buttonRegister.addEventListener("click", async function funcRegister() {
            ...
            let emailVorhanden = await auswertenEmailVorhanden(inputEmail.value);
            if (!emailVorhanden) {
        ...
        buttonLogin.addEventListener("click", function funcRegister() {
    ...
    async function auswertenEmailVorhanden(email) {
        ...
        let schonVorhanden = false;
        let registerElementMsg = document.getElementById("textLogin");
    ...
    async function list() {
        ...
        for (let i = 0; i < daten.length; i++) {
            ...
            text.appendChild(document.createTextNode(i + ": " + JSON.stringify(daten[i].lastname)));
