...
let divBezeichnung: HTMLDivElement;
...
function auswahlListener(): void {
     //Kopfform **********************************************************************************
     let kopfformEle: HTMLInputElement = <HTMLInputElement>document.getElementById(index.toString());
     kopfformEle.addEventListener ("change", function func0 (): void {
         ...
         //Kugelfarbe **********************************************************************************
     let kugelfarbeEle: HTMLInputElement = <HTMLInputElement>document.getElementById("" + (index + 2).toString() );
     kugelfarbeEle.addEventListener ("change", function func2 (): void {
         ...
         //Kugelfarbe **********************************************************************************
     let kopffarbeEle: HTMLInputElement = <HTMLInputElement>document.getElementById("" + (index + 1).toString());
...
function seitenWahl(): void { //momentane Seite wird generiert
    ...
    if (index <= 6) {
        divElement = <HTMLDivElement>document.getElementById("gridmain");  
        divBezeichnung = <HTMLDivElement>document.getElementById("gridright");  
        erstelleSelect(index + 1,  divElement, divBezeichnung);
        erstelleSelect(index + 2,  divElement, divBezeichnung);
        divElement = <HTMLDivElement>document.getElementById("gridheader"); 
...
function erstelleSelect(index: number,  divElementForm: HTMLDivElement, divElementBezeichnung: HTMLDivElement): void {
    ...
    for (let i: number = 0; i < daten[index].length; i++) {
    ...
    text.appendChild(document.createTextNode(bezeichnung[index]));
...
function deleteSelect(): void { // auswahlmöglichkeiten werden gelöscht, damit neue generiert werden können
    for (let i: number = 0; i < 3; i++) {
        let elem: HTMLElement = document.getElementById("" + (index + i).toString());
        elem.remove();
        let elemText: HTMLElement = document.getElementById("" + (index + i).toString() + (index + i).toString());
        elemText.remove();
    }
